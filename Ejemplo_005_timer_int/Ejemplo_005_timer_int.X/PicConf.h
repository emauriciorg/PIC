 ...
 * Author: Mauricio
 *
 * Created on 4 de enero de 2017, 2:46
 */
...
// PIC18LF8722 Configuration Bit Settings
...
#pragma config IESO = OFF        // Internal/External Oscillator Switchover bit (Two-Speed Start-up enabled)
