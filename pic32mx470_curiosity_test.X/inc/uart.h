...
#ifndef _SERIAL_DBG_H_    /* Guard against multiple inclusion */
...
#define PBCLK_FREQUENCY		(SYS_FREQ)
#endif
...
#define UART_FUNCTION_INIT(X,P,SP)          UARTConfigure(UART##X, UART_ENABLE_PINS_TX_RX_ONLY);\
...
#define UART_FUNCTION_RECIEVE_DATA_NOT_ISR(X)  void uart##X##_serial_reciever(void)\
                                                {\
                                                   ...
                                                   //send_debug_msg(UART##X##_INST.packet.packet_data);
